// src/screens/PlayScreen/PlayWW1/PlayWW1ScreenView.ts
...
export class PlayWW1ScreenView implements View {
    ...
    //** Create background for the inital dialogue portion */
